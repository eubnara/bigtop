...
%define kudu_name kudu

%define kudu_log /var/log/%{kudu_name}
%define kudu_run /var/run/%{kudu_name}
%define kudu_lib /var/lib/%{kudu_name}
%define kudu_doc %{_docdir}/%{kudu_name}-%{version}
...
Name: %{kudu_name}
Version: %{kudu_base_version}
Release: %{kudu_release}
Summary: Columnar storage engine for Hadoop
URL: https://kudu.apache.org
Group: Development/Libraries
BuildRoot: %{_topdir}/INSTALL/apache-%{kudu_name}-%{version}
License: ASL 2.0
Source0: apache-%{kudu_name}-%{kudu_base_version}.tar.gz
Source1: do-component-build
Source2: install_%{kudu_name}.sh
...
Requires: %{kudu_name} = %{version}-%{release}
...
Group: Development/Libraries
Requires: %{kudu_name}-client0 = %{version}-%{release}
...
%prep
%setup -n apache-%{kudu_name}-%{kudu_version}
